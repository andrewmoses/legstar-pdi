...
public class TransactionBinding 
    ...
    /** Child bound to value object property LastTransAmount(BigDecimal). */
    public ICobolPackedDecimalBinding _lastTransAmount;
    ...
    */
    ...
    private void initChildren() {
        ...
        _lastTransAmount = BF.createPackedDecimalBinding("LastTransAmount",
               "LastTransAmount", BigDecimal.class, this);
        _lastTransAmount.setCobolName("LAST-TRANS-AMOUNT");
        _lastTransAmount.setByteLength(8);
        _lastTransAmount.setTotalDigits(15);
        _lastTransAmount.setFractionDigits(2);
        _lastTransAmount.setIsSigned(true);
    ...
    public void setPropertyValue(final int index) throws HostException {
        ...
        * for instance.  */
        ...
        case 1:
            ...
            mValueObject.setLastTransAmount((BigDecimal) bindingValue);
            break;
        case 2:
