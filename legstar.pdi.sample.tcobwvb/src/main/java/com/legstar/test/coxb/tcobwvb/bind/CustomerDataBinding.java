...
import com.legstar.test.coxb.tcobwvb.PersonalData;
...
public class CustomerDataBinding 
     ...
     */
    public CustomerDataBinding(
            final CustomerData valueObject) {
    ...
    */
    ...
    private void initChildren() {
        ...
        _transactions = new TransactionsBinding("Transactions",
               "Transactions", this, null);
    ...
    public void setChildrenValues() throws HostException {
        ...
        if (_log.isDebugEnabled()) {
            _log.debug("Getting value from Value object property "
                    + "_transactions"
                    + " value=" + mValueObject.getTransactions());
        }
