...
public class ObjectFactory {
    ...
    private final static QName _CustomerData_QNAME = new QName("http://coxb.test.legstar.com/tcobwvb", "customerData");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://coxb.test.legstar.com/tcobwvb", name = "customerData")
